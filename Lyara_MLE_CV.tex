...
\begin{itemize}
    \item \textbf{\href{https://github.com/maxlyara1/multimodal-video-search}{Multimodal Video Search} -- поиск по видео:} Система поиска по речи, тексту на экране и описаниям кадров. Использованы Qdrant, FastAPI и локальные модели. На 50 проверочных запросах Hit@1 90\% и Hit@3 96\%.
    ...
    \item \textbf{\href{https://github.com/maxlyara1/find_anomalies_hackathon}{RedLab Hack} -- поиск аномалий:} Система обнаружения аномалий во временных рядах (декомпозиция сезонности, ML-прогноз) и Streamlit-сервис. 3-е место.
\end{itemize}
