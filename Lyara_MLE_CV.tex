...
\begin{itemize}
    ...
    \item \textbf{\href{https://github.com/maxlyara1/find_anomalies_hackathon}{RedLab Hack} -- поиск аномалий:} Система обнаружения аномалий в телеметрии промышленных датчиков и интерфейс для анализа результатов; 3-е место.
\end{itemize}
