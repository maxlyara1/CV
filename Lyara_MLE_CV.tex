...
\large{\textbf{ML Engineer / Data Scientist $\mid$ Опыт: 2.5+ года}} \\[3pt]
...
% Summary
\section{Обо мне}
Специализируюсь на полном цикле разработки ML-решений: от сбора бизнес-требований и развертывания (Docker, Kubernetes) до поддержки в промышленной эксплуатации. Экспертиза в прогнозировании временных рядов, оптимизации цепей поставок (MIP), RAG-системах и компьютерном зрении. Ориентируюсь на измеримый бизнес-эффект, надежность ML-систем и масштабируемую архитектуру.
...
\vspace{3pt}
\begin{itemize}
\item \textbf{Контрактная кампания (S\&OP):} Разработал систему прогнозирования B2B-продаж (CatBoost) для аптечных сетей. Автоматизировал запуск моделей и расчет прогнозов (Airflow), обеспечив стабильное качество прогнозирования, принятое бизнес-заказчиком.
\item \textbf{Оптимизация запасов (Safety Stocks):} Спроектировал MIP-модель (PuLP) для расчета страховых запасов. Учет сложных бизнес-ограничений позволил снизить замороженный капитал на 10\% при поддержании уровня сервиса в 98\%.
...
\begin{itemize}
    \item \textbf{\href{https://github.com/maxlyara1/AI_champ_OKKO}{AI ЧЕМП 2026 (Okko)} -- RAG по видео:} Система семантического поиска: распознавание речи, разбиение текста на перекрывающиеся фрагменты с использованием окон различного размера, комбинированный поиск (BGE-M3 + Qdrant) и локальное переранжирование (Qwen).
    \item \textbf{\href{https://github.com/maxlyara1/hackathon-manager-work-quality}{TulaHack} -- Оценка звонков:} Разработал NLP-сервис (FastAPI) для анализа работы менеджеров: сентимент-анализ, выявление слов-паразитов и суммаризация диалогов.
    \item \textbf{\href{https://github.com/maxlyara1/find_anomalies_hackathon}{RedLab Hack} -- Time Series:} Детектор аномалий во временных рядах телеметрии промышленных датчиков (3-е место).
\end{itemize}
