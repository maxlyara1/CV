...
\item \textbf{Оптимизация запасов (Safety Stocks):} Спроектировал MIP-модель (PuLP) для расчета страховых запасов. Учет сложных бизнес-ограничений позволил снизить замороженный капитал на 10\% при поддержании уровня сервиса на уровне 98\%.
